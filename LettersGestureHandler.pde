  ...
  public void OnGesture() {
    ...
    if (is_thumb)
    {
      if (!is_index && !is_middle && !is_ring && !is_pinky) {
            ...
            // Reconnaissance du J
            else if (angle_thumb >= 9 && angle_thumb <= 20 &&
                     distance >= 23) {
              println("J");
              letters[9] = true;
            }
    ...
    else if (is_index)
    {
      if (!is_pinky &&
          ...
          !is_thumb)
          {
            ...
            // Reconnaissance du I
            else if (angle_index >= 95 && angle_index <= 108 &&
                     distance <= 5)
            {
              println("D");
              letters[3] = true;
  ...
  else if (is_ring)
      {
        if (!is_index &&
            ...
            !is_thumb)
            {
              ...
              // Reconnaissance du I
              else if (angle_ring >= 155 && angle_ring <= 175 && distance <= 5)
              {
                println("I");
                letters[8] = true;
              }
        ...
        !is_pinky)
    {
      ...
      // Reconnaissance du J
      else if ((angle_hand_upper >= 170 && angle_hand_upper <= 180) &&
                (angle_hand_lower >= 0 && angle_hand_lower <= 5) &&
                 distance >= 20)
          {
            println("J");
            letters[9] = true;
    ...
    else if (is_thumb && is_index)
    {
      if (!is_pinky &&
          ...
          !is_ring)
          {
            ...
            // Reconnaissance K
            else if ((angle_thumb >= 85 && angle_thumb <= 120) &&
                     (angle_index >= 120 && angle_index <= 140) &&
                      distance >= 10)
                {
                  println("K");
                  letters[10] = true;
            ...
            if ((angle_thumb >= 115 && angle_thumb <= 145) &&
                ...
                (angle_middle >= 130 && angle_middle <= 160))
                {
                  ...
                  letters[7] = true;
                     ...
                     (angle_middle >= 120 && angle_middle <= 140) &&
                      distance >=10)
                {
                  println("K");
                  letters[10] = true;
    ...
    // MIDDLE & RING
    else if (is_middle && is_ring)
    {
      if (!is_index &&
          !is_pinky &&
          !is_thumb)
          {
            if ((angle_middle >= 110 && angle_index <= 125) &&
                (angle_ring >= 60 && angle_ring <= 80))
                {
                  println("H");
                  letters[7] = true;
                }
